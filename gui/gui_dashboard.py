...
class NoteList(customtkinter.CTkScrollableFrame):
    ...
    def add_item(self, note_obj, image=None):
        ...
        label.grid(row=len(self.label_list), column=0, pady=(10, 10), sticky="w")  # Increased padding for each item
...
class Dashboard(customtkinter.CTk):
    ...
    def create_user_notes_frame(self) -> customtkinter.CTkFrame:
        ...
        user_notes_frame.grid_rowconfigure(0, pad=60)  # increasing top padding

        main_info_label = customtkinter.CTkLabel(user_notes_frame,
                                                 text="Twoje notatki:",
